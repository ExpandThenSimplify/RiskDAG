...
from riskdag import RiskDAG, RiskNode
from scipy import stats

print("Testing RiskDAG installation...")

# The below depicts the simplest example use of a RiskDAG - users specify nodes, failure probabilities, 
# and loss distributions of DAG tasks.
